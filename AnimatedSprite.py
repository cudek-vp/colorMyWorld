...
class AnimatedSprite(arcade.Sprite):
    ...
    def __init__(self, filename: str = './resources/mr carrot.png', scale: float = 0.04, image_x: float = 0, image_y: float = 0,
                 ...
                 angle: float = 0, distance_to_change: int = 20, jump_path = None, walk_path = None, jump_sprites: int = 8, walk_sprites: int = 8):
        ...
        self.jump_sprites = jump_sprites
        self.setup()
    ...
    def setup(self):
        ...
        self.jump_textures = []
        for i in range(self.jump_sprites):
    ...
    def pymunk_moved(self, physics_engine, dx, dy, d_angle):
        ...
        if abs(self.y_odometer) > self.jump_sprites:
